...
- **Severity policy** — which violation classes are blocking/should-fix/advisory for this org. Absent, ds-conform falls back to generic defaults; present, the gate reflects actual team judgment. Lives in the manifest's hand-maintained zone.
