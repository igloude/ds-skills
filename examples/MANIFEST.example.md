...
> `/ds-prep` for a fictional `@acme/ui`, kept here as an example of the
> format defined in `skills/ds-prep/references/manifest-spec.md`.

# @acme/ui Conformance Manifest

<!-- generated: header -->
- **Package**: @acme/ui@4.2.0
- **Generated**: 2026-07-23, commit `f7a19d2`, by ds-prep v0.1.0
